...
<p align="justify">Apesar dos erros humanos influenciarem muito, temos outros problemas nos testes, sendo o primeiro o ambiente que não era totalmente livre de obstáculos, podendo ter variações pela proximidade com esses obstáculos. Outro ponto é a quantidade de fumaça no ambiente, devido aos vários testes, o ambiente se enchia de fumaça aparentemente desacelerando os vórtices, para isso o ambiente era ventilado a cada troca de diâmetro. Devido aos vários erros experimentais envolvidos, não foi possível calcular com exatidão a influência deles nos testes, por isso foi utilizado como parâmetro para visualização desses erros o desvio padrão nos tempos medidos.</p>
<p align="justify">Sendo assim, diversos testes foram feitos com cada diâmetro afim de encontrar um valor médio e dentre esses vários valores de tempo, seriam utilizados os mais próximos da média, excluindo valores muito fora do valor no qual o experimento estava tendendo, pois estes valores estavam claramente mais influenciados pelos erros experimentais. Com o objetivo de calcular o tempo médio, o desvio padrão desses tempos e a velocidade média, foram escolhidos e colocados na tabela 5 valores de tempos medidos próximos da média. Com esses valores foram calculados os pontos descritos na tabela abaixo:
</p>
